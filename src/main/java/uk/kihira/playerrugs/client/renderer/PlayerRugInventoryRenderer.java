...
public class PlayerRugInventoryRenderer implements SpecialModelRenderer<PlayerSkinRenderCache.RenderInfo> {
    ...
    @Override
    public void submit(PlayerSkinRenderCache.RenderInfo argument, @NonNull ItemDisplayContext type,
                       @NonNull PoseStack poseStack, @NonNull SubmitNodeCollector nodeCollector, int packedLight,
